...
public class ThietBi {
    ...
    @Column(name = "token_thiet_bi", unique = true, nullable = false, columnDefinition = "NVARCHAR(255)")
    private String tokenThietBi;

    @Column(name = "ten_thiet_bi", nullable = false, columnDefinition = "NVARCHAR(100)")
