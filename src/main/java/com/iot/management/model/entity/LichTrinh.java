...
public class LichTrinh {
    ...
    @Column(name = "ten_lich_trinh", columnDefinition = "NVARCHAR(100)")
    ...
    @Column(name = "lenh_khi_bat_dau", nullable = false, columnDefinition = "NVARCHAR(50)")
    private String lenhKhiBatDau;

    @Column(name = "lenh_khi_ket_thuc", nullable = false, columnDefinition = "NVARCHAR(50)")
     ...
     */
    @Column(name = "ngay_trong_tuan", nullable = false, columnDefinition = "NVARCHAR(20)")
