...
public class CauHinhTruongDuLieu {
    ...
    @Column(name = "ten_truong", nullable = false, columnDefinition = "NVARCHAR(50)")
    private String tenTruong;

    @Column(name = "ten_hien_thi", columnDefinition = "NVARCHAR(100)")
    private String tenHienThi;

    @Column(name = "kieu_du_lieu", nullable = false, columnDefinition = "NVARCHAR(20)")
    private String kieuDuLieu;

    @Column(name = "don_vi", columnDefinition = "NVARCHAR(20)")
    ...
    @Column(name = "dinh_nghia_enum", columnDefinition = "NVARCHAR(1000)")
