...
public class PhienBanFirmware {
    ...
    @Column(name = "so_phien_ban", nullable = false, columnDefinition = "NVARCHAR(20)")
    private String soPhienBan;

    @Column(name = "duong_dan_file", nullable = false, columnDefinition = "NVARCHAR(512)")
    private String duongDanFile;

    @Column(name = "hash_md5_file", columnDefinition = "NVARCHAR(32)")
    private String hashMd5File;
    
    @Column(name = "hash_sha256_file", columnDefinition = "NVARCHAR(64)")
    private String hashSha256File;

    @Column(name = "ghi_chu_phien_ban", columnDefinition = "NVARCHAR(1000)")
